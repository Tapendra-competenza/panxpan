<template>
  <div class="buildingTrust">
    <div class="page-title building-trust-background">
      <p>
        Building <strong>Trust</strong>
      </p>
    </div>
    <div class="page-content">
      <div class="building-trust-description">
        <img src="../../assets/images/security-icon.png">
          <p>
            Building partnerships is all about Trust. But when you've never met your partner face to face and you speak
            different languages, Trust is difficult to build. We've put Trust front and center in our platform so you have
            the right foundation to build prosperous partnerships with oversees manufacturers.
          </p>
        </div>
      <div class="row row-over">
        <div class="col-md-6 col-12 content-img"></div>
        <div class="mobile-img">
          <img src="../../assets/images/BT1_mobile.jpg">
        </div>
        <div class="col-md-6 col-12 greyBackground info-box custom-align">
          <div class="info-wrapper text-align-left">
            <img src="../../assets/images/stars.png">
              <h3 class="info-title-style text-align-left">More Than Ratings</h3>
              <p class="info-text-style">
                Filter manufacturers based on product categories, platform revenue, sales targets and investment funds
                available in addition to feedback from other local partners.  You have the ability to leave public feedback
                on any ventures you enter into so manufacturers know they need to work fairly with you.
              </p>
            </div>
        </div>
      </div>
      <div class="row row-over">
        <div class="col-md-6 col-12 info-box border-right">
          <div class="info-wrapper right-allined">
            <img src="../../assets/images/pig-icon.png">
              <h3 class="info-title-style">Fair Pricing</h3>
              <p class="info-text-style">
                Setting pricing is challenging in any partnership but with our platform you know you will be treated fairly.
                Manufacturers can't set pricing with specific local partners individually. Instead they globally set pricing
                based on country and quantity ordered. This way every local partner in a given country pays the same price
                relative to the quantity they order.
              </p>
            </div>
        </div>
        <div class="col-md-6 col-12 info-box">
          <div class="info-wrapper">
            <img src="../../assets/images/person-icon.png">
              <h3 class="info-title-style">Sales Escrow</h3>
              <p class="info-text-style">
                We help ensure you’ll get the goods you’re paying for.  Our platform holds your invoice payments in Escrow
                until the manufacturer ships the goods and uploads shipping tracking confirmation.  Only then
                will we release the funds to the manufacturer.
              </p>
            </div>
        </div>
      </div>
      <div class="row row-over">
        <div class="col-md-6 col-12 row-img"></div>
        <div class="mobile-img">
          <img src="../../assets/images/BT2_mobile.jpg">
        </div>
        <div class="col-md-6 col-12 greyBackground info-box custom-align">
          <div class="info-wrapper text-align-left">
            <img src="../../assets/images/repeat-icon.png">
              <h3 class="info-title-style text-align-left">Investment Escrow</h3>
              <p class="info-text-style">
                Our platform allows manufacturers to invest in a local partner in order to grow the local market for
                their products. Define clear monthly investment budgets for each manufacturer.  Those investment funds will
                then be pre-funded by the manufacturer and held in Escrow before the actual month begins.  You’ll know the funds
                will be there at the end of the month when you submit receipts.
              </p>
            </div>
        </div>
      </div>
      <div class="row row-over">
        <div class="col-12 info-box centered">
          <div>
            <img src="../../assets/images/message-icon.png">
              <h3 class="info-title-style">Paper Trail & Neutral Referee</h3>
              <p class="info-text-style">
                Each venture has its own detailed event and message history log where we automatically track changes.
                Investment and sales forecasts also have version tracking so you can track changes over time.
              </p>
              <p class="info-text-style margin-top-20">
                Automatic change tracking and history helps resolve disputes and can be used if disputes need to be
                escalated to PanXpan for arbitration.
              </p>
            </div>
        </div>
      </div>
        ...
        <div class="introduction-footer">
          <div>
            <img src="../../assets/images/logo_small.png">
              <div class="introduction-footer-text">
                <p>
                  Our platform is free to use. Apply to unlimited business opportunities and enter into unlimited ventures.
                </p>
                <p>
                  Only if you enter into ventures
                  where you are given investment,
                  we’ll take 10% of your investment
                  budget. The 10% service fee we
                  charge covers money transfer,
                  support and platform running
                  costs.
                </p>
              </div>
            </div>
          <div>
            <button type="button" class="btn create-account" onclick="window.location = '/find/search-products'">
              View Opportunities in {{countryValue.name}}
            </button>
          </div>
        </div>
      </section>
...
<script>
  ...
  return window.location = process.env.appUrl+method;
  }},
  head () {
  return {
  meta: [
  ...
  created() {
  document.title = "Building Trust for Local Partners – PanXpan";
  axios.get('https://api.ipify.org?format=json')
  .then(response => {
  axios.get('https://ipinfo.io/' + response.data.ip + '/geo')
  .then(data => {
  function findCountry (country) {
  return country.code2 === data.data.country
  }

  this.countryValue = this.rawCountryData.find(findCountry)
  })
  .catch(e => {
