<template>
  <div>
    <section class="body">
      <div class="about homepage-about how-it-works how-it-works-LP-cover">
        <div class="title-line"></div>
        <h4>Sell Products from the Best Manufacturers in the World</h4>
        <div class="title-line"></div>
      </div>
    </section>
    <section>
      <div class="container introduction">
        <div class="row">
          <div class="col-sm-6 col-xs-12 left-step">
            <h4>Create an Account</h4>
            <img class="left-step-background" src="../../assets/images/1.png"/>
            <p>Enter information about you and your company (if you have one) and where you do business locally.</p>
          </div>
          <div class="col-sm-6 col-xs-12">
            <img src="../../assets/images/lp1-img.png" class="img-responsive">
          </div>
        </div>
        <div class="row ">
          <div class="col-sm-6 col-xs-12">
            <img class="img-responsive" src="../../assets/images/lp2-img.png"/>
          </div>
          <div class="col-sm-6 col-xs-12 right-steps">
            <h4>Find Proposals</h4>
            <img class="right-steps-background" src="../../assets/images/2.png"/>
            <p>Find international manufacturers that are looking to expand into your country.</p>
            <p>
              Review their products, invesment budgets and what they are looking for in a local partner.
            </p>
          </div>
        </div>
        <div class="row ">
          <div class="col-sm-6 col-xs-12 left-step">
            <h4>Submit Offers</h4>
            <img class="left-step-background" src="../../assets/images/3.png"/>
            <p>For interesting proposals, identify what products you would like to sell locally.</p>
            <p>Present a sales and investment forecast over the contract term. Get quick feedback from international manufacturers on your offer.</p>
          </div>
          <div class="col-sm-6 col-xs-12">
            <img class="img-responsive" src="../../assets/images/lp3-img.png"/>
          </div>
        </div>
        <div class="row ">
          <div class="col-sm-6 col-xs-12">
            <img class="img-responsive" src="../../assets/images/lp4-img.png"/>
          </div>
          <div class="col-sm-6 col-xs-12 right-steps">
            <h4>Consolidate Global Expasion</h4>
            <img class="right-steps-background" src="../../assets/images/4.png"/>
            <p>Consolidate all your international suppliers into one platform so you can easily manage monthly investment and monthly purchases from a central location.</p>
            <p>Identify new manufacturers easily and add them effortlessly to grow your product base.</p>
          </div>
        </div>
      </div>
    </section>
...
<script>
  ...
  created () {
  document.title = "How it Works for Local Partners – PanXpan";
